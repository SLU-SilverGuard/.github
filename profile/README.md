...
| 仓库 | 当前职责 | 主要技术栈 |
| --- | --- | --- |
| `backend` | 鉴权、设备归属、sync、family API、应用与娱乐管控云端状态 | Laravel `^13.4`、PHP `^8.4` |
| `companion` | 本地采集、自动同步、设备保护、应用与娱乐管控执行 | Kotlin 2.3.21、Compose BOM 2026.05.00、Hilt、Room、WorkManager 2.11.2、Retrofit 3、OkHttp 5 |
| `guardian` | Android 家属端设备查看与远程管理 | Kotlin 2.3.21、Compose BOM 2026.05.00、Hilt、Retrofit 3、OkHttp 5、DataStore |
| `frontend` | 多端家属端前端与打包 | Vue 3.5.34、Vue Router 5.0.7、TypeScript 6.0.3、Vite 8.0.13、Tauri 2 |
